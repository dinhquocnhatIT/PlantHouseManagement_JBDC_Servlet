...
public class OrderDao implements IOrderDao{
    ...
    private static final String INSERT_ORDER_SQL =  "INSERT INTO order_details" +
            " (order_Name, phoneNumber, city, price, email, quantity, idProduct, IDStatus)" +
            " VALUES"+ " (?,?,?,?,?,?,?,?);";
    ...
    private static final String SELECT_ORDER_INFO = "SELECT p.productID,p.image,t.typeName, o.quantity, p.price" +
            ...
            " inner join typeproduct as t on p.typeID = t.typeID) where order_Name = ? and IDStatus =0;";
    private static final String CONFIRM_ORDER_USER = "Update order_details set IDStatus =1 where order_Name=?";
    @Override
