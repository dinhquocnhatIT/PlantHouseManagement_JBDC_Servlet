...
//        }
    ...
    private void deleteProduct(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        request.setAttribute("delete", "Do you wanna delete?");
    ...
    private void updateProduct(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (!constraintViolations.isEmpty()) {
            request.setAttribute("errors", getErrorFromContraint(constraintViolations));
            request.setAttribute("product", product);
            RequestDispatcher requestDispatcher = request.getRequestDispatcher("WEB-INF/view/editproduct.jsp");
            requestDispatcher.forward(request, response);
        } else {
        ...
        for (Part part : request.getParts()) {
            if (part.getName().equals("img")) {
                ...
                if (!file.equals("")) {
                    ...
                    part.write("C:\\shoeshop\\ShoesShop-main\\WebCase\\src\\main\\webapp\\images" + file);
