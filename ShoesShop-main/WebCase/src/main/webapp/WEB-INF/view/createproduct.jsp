                    ...
                    <div class="row">
                        <c:choose>
                            <c:when test="${action.equals('create')}">
                                <div><h3 class="w-100 text-center m-2" style="color: black"> Create Product</h3></div>
                            </c:when>
                            <c:otherwise>
                                <div><h3 class="w-100 text-center m-2" style="color: black"> Edit Product</h3></div>
                            </c:otherwise>
                        </c:choose>
                        <div class="col-lg-12">
                            <form method="post" enctype="multipart/form-data" >
                                ...
                                <div class="form-group">
                                    <label>Price: </label>
                                    <input type="number" class="form-control" name="price" id="price" size="45" value="${product.getPrice()}"/>
                                </div>
                                <div class="form-group">
                                    <label>Quantity: </label>
                                    <input type="number" class="form-control" name="quaility" id="quaility" size="45" value="${product.getQuantity()}"/>
                                </div>
                                <div class="form-group">
