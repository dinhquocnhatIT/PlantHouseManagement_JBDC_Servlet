...
<div id="wrapper">
    ...
    <a href="/users?action=login" style="font-size: 18px;
    border: 1px solid #8f8181;
    background-color: #b1bcbe; color: #06234e">Back to Login</a>
                    ...
                    <div class="col-md-10 col-lg-6 col-xl-5">
                        <div class="card">
                            ...
                            <div class="text-center account-logo-box">
                                <div class="mt-2 mb-2">
                                    <a href="/loginform.jsp" class="text-success">
                                        <div><span><img src="logo-cay-xanh.png" alt="" height="50"></span></div>
                                        <span class="text-white">PLANT HOUSE</span>
                                    </a>
                                </div>
                            </div>
